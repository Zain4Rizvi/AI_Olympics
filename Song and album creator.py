...
openai.api_key = "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"
...
for i in range(num_songs):
    ...
    text_prompt = "Act as artist: Write lyrics for a song of this genre with 2-4 verses of the" + text_prompt1 + "genre with the topics of" + text_prompt2
...
chatgpt_response = openai.ChatCompletion.create(
        ...
        max_tokens=2000,
        top_p=0.95)
topics = chatgpt_response['choices'][0]['message']['content'].strip() #update topics 
print(topics)
...
pre_img_prompt = """Describe a """ +  text_prompt3 + """wordless album cover with topic: """ + topics + "in 20 words"
